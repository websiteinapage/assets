...
class Globalauth2Component extends Component {
        ...
        if($this->controller->Auth->loggedIn()):
            ...
            $signup = $this->controller->Signup->find('first', array(
                'conditions'=>array(
                    ...
                    'Signup.application_id'=>$this->app['Application']['id']
                )
            ));
            if(empty($signup)):
                // init signup
                $this->controller->Signup->save(array(
                    'user_id'=>$saveduser['User']['id'],
                    'application_id'=>$this->app['Application']['id'],
                    'domain'=>$this->app['Application']['domain']
                ), false);
            endif;
